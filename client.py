...
def receive_instructions():
    while True:
        ...
        if instructions == "START":
            # Start the game
            pass  # Implement your game start logic here

# Start threads for sending data and receiving instructions
send_thread = threading.Thread(target=send_data(bird_y))
recv_thread = threading.Thread(target=receive_instructions)
send_thread.start()
recv_thread.start()
